            ...
            leading: Consumer<Product>(
              ...
              builder: (context, product, _) => IconButton(
                ...
                onPressed: () {
                  ...
                  if (products.itemsFavorite.isEmpty) {
                    products.itemsList;
                  }
              ...
              child: InkWell(
                onLongPress: () {
                  if (cart.itemsCount > 0) {
                    showToast(context, cart.addItem,
                        product: product, text: "Item removido do carrinho");
                  }
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    //
                    showToast(context, cart.removeQuant,
                        product: product, text: "Item adicionado do carrinho");
                  },
                  color: Theme.of(context).accentColor,
                ),
              ),
